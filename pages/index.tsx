					...
					<div className='flex h-full w-full pt-[48px] sm:pt-0'>
						{showSidebar ? (
							<div>
								...
								<IconArrowBarLeft
									className='z-50 fixed top-5 left-[270px] sm:top-0.5 sm:left-[270px] sm:text-neutral-100 dark:text-white cursor-pointer hover:text-gray-300 dark:hover:text-gray-300 h-7 w-7 sm:h-8 sm:w-8'
							...
							<IconArrowBarRight
								className='fixed text-white z-50 top-2.5 left-4 sm:top-0.5 sm:left-4 sm:text-neutral-100 dark:text-white cursor-pointer hover:text-gray-300 dark:hover:text-gray-300 h-7 w-7 sm:h-8 sm:w-8'
								onClick={() => setShowSidebar(!showSidebar)}
							/>
						)}
