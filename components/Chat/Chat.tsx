...
export const Chat: FC<Props> = ({
	...
	return (
		<div className='relative flex-1 overflow-none dark:bg-[#343541] bg-[#001228]'>
				...
				<>
					<div className='overflow-scroll max-h-full' ref={chatContainerRef}>
						{conversation.messages.length === 0 ? (
								...
								<div className='flex flex-col mx-auto pt-12 space-y-10 w-[350px] sm:w-[600px]'>
									{models.length === 0 ? null : (
										<div className='flex justify-center items-center w-full'>
											<img className='h-16 brightness-0 invert' src='/turing.gif' alt='' />
											<div className='pl-2 text-4xl font-medium text-center text-gray-100 dark:text-gray-100'>Turing</div>
										</div>
									)}
							...
							<>
								<div className='flex justify-center py-2 text-neutral-200 bg-[#0044ffaa] dark:bg-[#444654] dark:text-neutral-200 text-sm'>
								...
								<div className='bg-[#001228] dark:bg-[#343541] h-[162px]' ref={messagesEndRef} />
							</>
						)}
					</div>
