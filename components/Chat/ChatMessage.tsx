		...
		<div
			className={`group ${
				message.role === "assistant"
					? "text-gray-300 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 bg-[#0044ff30] dark:bg-[#444654]"
					: "text-gray-300 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 bg-[#001228] dark:bg-[#343541]"
			}`}
					...
					{message.role === "user" ? (
						<div className='flex w-full'>
							{isEditing ? (
								...
								<div className='prose-invert dark:prose-invert whitespace-pre-wrap'>{message.content}</div>
							)}
